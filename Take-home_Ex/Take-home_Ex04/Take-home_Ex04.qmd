...
```{r}
#Load packages
pacman::p_load(readxl, knitr, lubridate, ggHoriPlot, ggthemes, plotly, directlabels, ggbraid, tidyverse)
```
...
Other partners - Volatility is further observed with smaller trading partners
- Brazil, Mexico (high volatility towards end 2022), Brunei, Ireland, Israel => 5
...
selected_countries = c("Mainland China", "Malaysia", "United States", "South Korea")
