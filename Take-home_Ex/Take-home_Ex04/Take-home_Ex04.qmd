...
```{r}
#Load packages
pacman::p_load(readxl, knitr, lubridate, ggHoriPlot, ggthemes, patchwork, plotly, directlabels, ggbraid, ggtext, tidyverse)
```
...
round(ori, 5) # The origin of horizon plot

round(sca, 5) # The horizon scale cutpoints
```
...
round(ori_roc, 5) # The origin of horizon plot

round(sca_roc, 5) # The horizon scale cutpoints
```
...
#### 3.2.2 Y-on-Y Change from 2020 to 2022
