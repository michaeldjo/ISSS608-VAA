...
-   Set the colors of the line and ribbons using `scale_color_manual()` and `scale_color_fill()`
    ...
    ::: callout-tip
    The color choice is based on this [article](https://davidmathlogic.com/colorblind/#%23D81B60-%231E88E5-%23FFC107-%23004D40)
    :::
...
With such insights observed above, it makes sense to include them in the plot as well. Hence `annotate()` functions are used to add the text label and arrows. Refer to code below for more details.
