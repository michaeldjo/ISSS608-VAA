...
```{r}
#Load packages
pacman::p_load(readxl, knitr, lubridate, ggrepel, ggHoriPlot, ggthemes, patchwork, directlabels, ggbraid, CGPfunctions, ggtext, gganimate, gifski, scales, tidyverse)
```
...
p2_text <- data.frame(label = c("Start of\nrecession", "", "Start of\nrecession", "Reversal in\nBalance"),  
                         ...
                         x = c(as.Date("2020-08-01"), 0, as.Date("2020-08-01"), as.Date("2020-09-01")),
                         y = c(2000000000, 0, 2000000000, 2000000000))

arrowp2<- data.frame(Countries = c("Australia", "India", "Philippines", "Cambodia"),
                      x = c(as.Date("2021-02-01"), 0, as.Date("2021-02-01"), as.Date("2020-09-01")),
                      y = c(2000000000, 0, 2000000000, 1600000000),
                      xend = c(as.Date("2022-07-01"), 0, as.Date("2022-07-01"), as.Date("2020-10-01")),
                      yend = c(2000000000, 0, 1400000000, 200000000))
...
p3_text <- data.frame(label = c("Start of\nrecession", "", "", ""),  
                         ...
                         x = c(as.Date("2020-9-01"), 0, 0, 0),
                         y = c(1700000000, 0, 0, 0))

arrowp3<- data.frame(Countries = c("Germany", "France", "Switzerland", "United Kingdom"),
                      x = c(as.Date("2021-3-01"), 0, 0, 0),
                      y = c(1700000000, 0, 0, 0),
                      xend = c(as.Date("2022-08-01"), 0, 0, 0),
                      yend = c(1300000000, 0, 0, 0))
