...
-   As revealed by EDA, all categorical variables are more than two. Hence `ggbetweenstats` will be used for one-way ANOVA testing.
...
p1 <- ggbetweenstats(
  ...
  title = "One-way ANOVA reveals differences in 2022 resale price across different towns (>850 transactions)",
  type = "np", 
